...
?>
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td height="26" bgcolor="#BCE0A8"><div align="center" class="style9">Apple</div></td>
        <td bgcolor="#BCE0A8"><div align="center" class="style9">Samsung</div></td>
        <td bgcolor="#BCE0A8"><div align="center" class="style9">Asus</div></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
